...
import es.uvigo.ei.sing.icpms.core.io.LineToElementConverter;

/**
 * A {@code InvalidDataException} is thrown by the
 * {@code LineToElementConverter} when the data is invalid.
 * 
 * @author hlfernandez
 * @see LineToElementConverter
 */
