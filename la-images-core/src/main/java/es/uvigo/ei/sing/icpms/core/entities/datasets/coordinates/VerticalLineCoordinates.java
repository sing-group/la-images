 ...
 *
 */
public class VerticalLineCoordinates extends AbstractLineCoordinates {
	private static final long serialVersionUID = 1L;

	/**
	 * Constructs a new {@code VerticalLineCoordinates} with the specified 
	 * values.
	 * 
	 ...
	 */
	public VerticalLineCoordinates(double rangeTick, double rangeStart,
