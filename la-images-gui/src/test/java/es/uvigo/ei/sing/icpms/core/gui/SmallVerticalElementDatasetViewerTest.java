...
public class SmallVerticalElementDatasetViewerTest {
	private static final ElementData VERTICAL_ELEMENT_DATA = ElementData.createElementData("Test", 
		new LineData[]{
			new LineData(
				"Line 1", 
				new double[]{1.0d,1.0d,1.0d}, 
				new VerticalLineCoordinates(0.1d, 0.0d, 0.2d, 0.0d) 
			),
			new LineData(
				"Line 2", 
				new double[]{1.0d, 1.0d ,1.0d}, 
				new VerticalLineCoordinates(0.1d, 0.0d, 0.2d, 0.1d) 
			),
			new LineData(
				"Line 3", 
