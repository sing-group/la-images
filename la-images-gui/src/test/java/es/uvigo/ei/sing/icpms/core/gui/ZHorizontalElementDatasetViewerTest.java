...
public class ZHorizontalElementDatasetViewerTest {
		...
		ElementData.createElementData("Test", 
			new LineData[]{
				new LineData(
					...
					new HorizontalLineCoordinates(0.1d, 0.0d, 0.5d, 0.0d)
				),
				new LineData(
					"Line 2",
					new double[] { 1.0d, 1.0d, 1.0d, 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.0d, 0.5d, 0.1d)
				),
				new LineData(
					"Line 3", 
					new double[] { 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.3d, 0.5d, 0.2d)
				),
				new LineData(
					"Line 4",
					new double[] { 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.2d, 0.4d, 0.3d)
				),
				new LineData(
					"Line 5",
					new double[] { 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.1d, 0.3d, 0.4d) 
				),
				new LineData(
					"Line 6",
					new double[] { 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.0d, 0.2d, 0.5d)
				),
				new LineData(
					"Line 7",
					new double[] { 1.0d, 1.0d, 1.0d, 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.0d, 0.5d, 0.6d)
				),
				new LineData(
					"Line 8",
					new double[] { 1.0d, 1.0d, 1.0d, 1.0d, 1.0d, 1.0d },
					new HorizontalLineCoordinates(0.1d, 0.0d, 0.5d, 0.7d)
				)
			}
		);
